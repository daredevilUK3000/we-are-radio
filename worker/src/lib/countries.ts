/**
 * ISO 3166-1 alpha-2 country codes, for validating a contest entry's country.
 * Kept identical to app/src/shared/countries.ts (the entry form's dropdown) -
 * change both together. XK (Kosovo) isn't formally in ISO 3166-1 but is the
 * code everyone uses for it, and Kosovan creators should be able to enter.
 */
...
export const isCountryCode = (code: string) => SET.has(code);

/** English country name, for share-page titles. Falls back to the code itself. */
