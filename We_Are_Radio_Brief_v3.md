# WE ARE RADIO
### Developer Brief — Personal Digital Radio Network & Broadcasting Platform (v3)

**Revision note:** This is an update to the v2 brief. It carries forward the three decisions from v2, plus one new one:
...
We Are Radio is a personal digital radio network and broadcasting platform built around Kizzi's music catalogue, personality, voice and media background, with **Kizzi Radio as its flagship channel**.

The central concept is:

We Are Radio is not simply a music-streaming app. It is a personal radio network in which Kizzi Radio is the flagship station — Kizzi is the presenter there — and AI acts as the production assistant across the network.
...
- Discover different We Are Radio channels (only channels marked `live`).
...
## 11. WE ARE RADIO STUDIO

The private administration system, covering all six channels — including the five not yet `live`. Main navigation:
...
We Are Radio is a personal digital radio network where Kizzi's original music, voice and ideas — broadcast through the flagship Kizzi Radio channel and, over time, the network's other channels — are turned into continuously programmed radio shows and on-demand audio, with AI acting as his virtual radio producer.
